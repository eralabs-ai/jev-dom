// Vendored unchanged from sdras/jev-webmcp-extension@1ec3afb (Apache-2.0), src/core/spans.js.
// The DOM agent uses the same trick for text fields that the extension uses for
// free-text tool arguments: Jev never writes, it picks a span of the user's words.
